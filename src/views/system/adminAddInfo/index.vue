...
export default {
  data() {
    return {
      ...
      tableColId: "menuId",
      tableLabel: [
        { label: "id", param: "menuId", align: "center" },
  ...
  methods: {
    //获取所有组织
    getData() {
      selectMenu(this.query).then((res) => (this.treeData = res.data));
    },
    //获取组织类型下拉框
    // getAttr() {
